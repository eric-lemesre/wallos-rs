...
Total : **73** exigences — 43 verified · 2 implemented · 28 draft.
...
| `REQ-I18N-002` | Absence de chaîne littérale dans le code | medium | ⚪ draft |
...
| ID | Titre | Criticité | Statut |
|----|-------|-----------|--------|
| `REQ-NOT-001` | Rappel avant échéance | high | ⚪ draft |
| `REQ-NOT-002` | Idempotence de l'ordonnanceur | high | ⚪ draft |
| `REQ-NOT-003` | Canal e-mail | high | ⚪ draft |
| `REQ-NOT-004` | Canaux de messagerie tiers | medium | ⚪ draft |
| `REQ-NOT-005` | Webhook générique | medium | ⚪ draft |
...
| `REQ-SEC-006` | En-têtes de sécurité et politique de contenu | medium | ⚪ draft |
...
| `REQ-STA-004` | Répartition par catégorie et par payeur | medium | ⚪ draft |
...
| `REQ-STA-008` | Détermination des agrégats | high | 🟡 implemented |
...
| `REQ-SUB-005` | Suppression d'un abonnement | high | ⚪ draft |
...
| `REQ-SUB-016` | Import et export des données | medium | ⚪ draft |
...
| `REQ-SYN-002` | Pierres tombales | high | ⚪ draft |
| `REQ-SYN-003` | Récupération incrémentale par curseur | high | ⚪ draft |
| `REQ-SYN-004` | Poussée des modifications locales | high | ⚪ draft |
